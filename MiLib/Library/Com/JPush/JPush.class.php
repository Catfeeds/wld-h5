...
require_once("core/PushPayload.class.php");
require_once("core/ReportPayload.class.php");
require_once("core/DevicePayload.class.php");
require_once("core/SchedulePayload.class.php");
require_once("core/JPushException.class.php");
