...
require 'AopSdk.php';
require 'config.php';
require 'request/AlipayTradeWapPayRequest.php';
require 'request/AlipayTradeQueryRequest.php';
require 'request/AlipayTradeRefundRequest.php';
require 'request/AlipayTradeCloseRequest.php';
require 'request/AlipayTradeFastpayRefundQueryRequest.php';
// require 'request/AlipayDataDataserviceBillDownloadurlQueryRequest.php';
