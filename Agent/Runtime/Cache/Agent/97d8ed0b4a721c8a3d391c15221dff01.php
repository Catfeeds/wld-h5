...
<script type="text/javascript">
  window.onload=function(){
    ...
    $('input[name="keys"]').focus(function() {
      ...
      $('#keys_btn').css('background-image','url(/wldApp/Agent/Agent/View/Public/images/mobile/s-02.png)');
    });
    $('input[name="keys"]').blur(function() {
      $('#search').css("border",'solid 1px #ccc');
      $('#keys_btn').css('background-image','url(/wldApp/Agent/Agent/View/Public/images/mobile/s-03.png)');
    });
  }
</script>
...
function getnum(){
  ...
  <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="notice-list">
