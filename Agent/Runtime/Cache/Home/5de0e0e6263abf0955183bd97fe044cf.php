...
<title>商家后台管理</title>
<link rel="stylesheet" type="text/css" href="/wldApp/Agent/Home/View/Public/css/sellerIndex.css">
	...
	<div class="pretant_type fl" id="channel">
		<ul>
			<li class="" id="channel00">
				...
				<img src="/wldApp/Agent/Home/View/Public/images/index/notice.png">
				<span>公告</span>
				</a>
				<div class="li_bon">
					<img src="/wldApp/Agent/Home/View/Public/images/index/bon.png" alt="">
				</div>				
			</li>
			<li class="" id="channel01">
				<a href="<?php echo U('Activation/index');?>" target="right">
				<img src="/wldApp/Agent/Home/View/Public/images/index/cdkey.png">
				<span>激活码串</span>
				</a>
				<div class="li_bon">
					<img src="/wldApp/Agent/Home/View/Public/images/index/bon.png" alt="">
			...
			<li class="" id="channel02">
				<a href="<?php echo U('Member/index');?>" target="right">
				<img src="/wldApp/Agent/Home/View/Public/images/index/infomen.png">
				<span>信息管理</span>
				</a>
				<div class="li_bon">
					<img src="/wldApp/Agent/Home/View/Public/images/index/bon.png" alt="">
			...
			<li class="" id="channel03">				
				...
				<img src="/wldApp/Agent/Home/View/Public/images/index/shopcheck.png">
				<span>微商审核</span>
				</a>
				<div class="li_bon">
					<img src="/wldApp/Agent/Home/View/Public/images/index/bon.png" alt="">
			...
			<li class="" id="channel04">				
				<a href="<?php echo U('Material/index');?>" target="right">
				<img src="/wldApp/Agent/Home/View/Public/images/index/materirl.png">
				<span>资料库</span>
				</a>
				<div class="li_bon">
					<img src="/wldApp/Agent/Home/View/Public/images/index/bon.png" alt="">
