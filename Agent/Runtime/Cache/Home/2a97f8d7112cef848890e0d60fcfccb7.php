...
<div class="content-s w_960">
	<div class="page-title">
		<div class="page-tit-name">全部代理</div>
	</div>
	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="agent-list-box" onclick="window.location.href='/wldApp/agent.php/Home/Agentntrol/details?Id=<?php echo ($vo["c_id"]); ?>'">
		<div class="agent-list-l fl">
			<a href="/wldApp/agent.php/Home/Agentntrol/details?Id=<?php echo ($vo["c_id"]); ?>">
				<img src="/wldApp/<?php echo ($vo["c_headimg"]); ?>" alt="" class="agentimgs">
				<img src="/wldApp/Agent/Home/View/Public/images/eye.png" alt="">
			</a>
		</div>
		<div class="agent-list-r fl">
			...
			<div class="agent-company" style="color:#ff7112;font-size:18px;">等待区代审核</div>
