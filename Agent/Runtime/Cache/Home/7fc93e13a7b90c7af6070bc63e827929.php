...
<div class="wrap-page">
    <div class="login-main-bg">
        <div class="login-top-main">
            <div class="login-top-logo txtc"><img src="/wldApp/Agent/Home/View/Public/images/login/login-02_03.png" alt=""></div>
        ...
        <img src="/wldApp/Agent/Home/View/Public/images/mobile/login-bg.jpg" alt="" id="login-bg">
    </div>    
</div>    
