...
<div class="content-s w_960">
	...
	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "$baoqian" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="agent-list-box" onclick="window.location.href='/wldApp/agent.php/Home/Shopcheck/details?Id=<?php echo ($vo["c_id"]); ?>'">
