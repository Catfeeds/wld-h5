...
class YsepayScanpay {
    ...
    function get_code($order)
    {
        ...
        $myParams = array();
        $myParams['business_code'] = '21000009';
        $myParams['charset'] = 'utf-8';
        $myParams['method'] = 'ysepay.online.directpay.createbyuser';
        $myParams['notify_url'] = 'https://testapi.iweilingdi.com/index.php/Order/Scanpay/respond_notify';
        $myParams['out_trade_no'] = $order;
        $myParams['partner_id'] = 'shanghu_test';
        $myParams['return_url'] = 'https://testapi.iweilingdi.com/index.php/Order/Scanpay/respond_return';
...
//        $myParams['support_card_type']           = 'debit';
    ...
    function get_dfjj($order)
    {
        ...
        $biz_content_arr = array(
            ...
            "bank_name" => "工商银行岳阳支行",
            "bank_city" => "岳阳市",
            "bank_account_no" => "6222021907005326066",
