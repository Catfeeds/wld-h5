...
<meta charset="utf-8">
<title>商家后台管理</title>
<link rel="stylesheet" type="text/css" href="/wldApp/Agent/Shop/View/Public/css/sellerIndex.css">
	...
	<div class="pretant_type fl" id="channel">
		<ul>
			<li class="" id="channel00">
				...
				<img src="/wldApp/Agent/Shop/View/Public/images/index/notice.png">
				<span>公告</span>
				</a>
				<div class="li_bon">
					<img src="/wldApp/Agent/Shop/View/Public/images/index/bon.png" alt="">
				</div>				
			</li>			
			<li class="" id="channel01">				
				<a href="<?php echo U('Shop/index');?>" target="right">
				<img src="/wldApp/Agent/Shop/View/Public/images/index/shopcheck.png">
				<span>商品上传</span>
				</a>
				<div class="li_bon">
					<img src="/wldApp/Agent/Shop/View/Public/images/index/bon.png" alt="">
			...
			<li class="" id="channel02">				
				...
				<img src="/wldApp/Agent/Shop/View/Public/images/index/materirl.png">
				<span>资料下载</span>
				</a>
				<div class="li_bon">
					<img src="/wldApp/Agent/Shop/View/Public/images/index/bon.png" alt="">
			...
			<li class="" id="channel03">				
				<a href="<?php echo U('Shop/producelist');?>" target="right">
				<img src="/wldApp/Agent/Shop/View/Public/images/index/infomen.png">
				<span>我的产品</span>
				</a>
				<div class="li_bon">
					<img src="/wldApp/Agent/Shop/View/Public/images/index/bon.png" alt="">
