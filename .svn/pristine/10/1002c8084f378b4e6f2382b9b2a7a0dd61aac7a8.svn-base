...
<body> 	
    <div class="login_top">
       <div class="login_img">
           <img src="/wldApp/Agent/Home/View/Public/images/index/logo.png" alt="">
       </div>
    </div> 
    ...
    <div class="login_body">
        <div class="login_box">
            <div class="box_img">
               <img src="/wldApp/Agent/Home/View/Public/images/index/arealogin.png" alt="">
           </div>
           <div class="box_content">
                <div class="login_row">
                    <span><img src="/wldApp/Agent/Home/View/Public/images/index/ico_Login_name.png">用户名</span>
                    <input name="username" type="text" id="sj_admin_name" class="txt_name" placeholder="请输入用户名">
                </div>
                <div class="clear"></div>
                <div class="login_row login_row_2">
                    <span><img src="/wldApp/Agent/Home/View/Public/images/index/ico_login_pwd.png">密 码</span>
                    <input name="password" type="password" id="sj_admin_pwd" class="txt_name txt_pwd" placeholder="请输入密码">                  
                </div>
                <div class="clear"></div>
                <div class="login_row">
                    <span><img src="/wldApp/Agent/Home/View/Public/images/index/ico_login_yzm.png">验证码</span>
...
<script type="text/javascript">
    ...
    function fleshVerify() {
        ...
        document.getElementById("verifyImg").src = "/wldApp/agent.php/Home/Index/verify/" + time;
    }
</script> 
</html>