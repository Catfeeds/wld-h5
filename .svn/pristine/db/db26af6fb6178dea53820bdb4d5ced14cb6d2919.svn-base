...
class DemoYspay{
    ...
    {
        $this->param = array();
        $this->param['pfxpath'] = GetHost() . "Uploads/certs/shanghu_test.pfx";
        $this->param['businessgatecerpath'] = GetHost() . "Uploads/certs/businessgate.cer";
...
//        $myParams['support_card_type']           = 'debit';
    ...
    function get_money()
    {
        ...
        return MessageInfo(0,'成功',$myParams);
       // return $myParams;
        //var_dump($myParams);
    }
