	...
	<div class="w_top_con w_100">
		...
		<div class="fl top_left">
			<a href="javascript:void(0);">
				<img src="/wldApp/Agent/Home/View/Public/images/sellerIndex/seller_logo.png">
			</a>
		</div>
		<div class="fr top_right">
			<ul>
				<li>欢迎您<span><a href="<?php echo U('Index/updatepassword');?>" target="right"><?php echo (session('_ADMIN_NAME')); ?></a></span></li>
				<li>|</li>
				...
				<li>
					<a href="javascript:;" onclick="window.parent.frames.right.location.reload()">
						<img src="/wldApp/Agent/Home/View/Public/images/sellerIndex/ico_refresh.png">
					</a>
				</li>
			</ul>
			<div class="clear"></div>	
